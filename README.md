...
|------|-------------|------|---------|:--------:|
| <a name="input_acc_bound_claims"></a> [acc\_bound\_claims](#input\_acc\_bound\_claims) | JWT/OIDC auth Method role for AWS Account in a Vault server | <pre>map(object({<br>    role_name    = string<br>    bound_claims = map(string)<br>  }))</pre> | n/a | yes |
...
| <a name="input_create_acc_role"></a> [create\_acc\_role](#input\_create\_acc\_role) | Enable Account JWT Auth Method Role or not | `bool` | n/a | yes |
...
| <a name="input_create_aws_secret_backend"></a> [create\_aws\_secret\_backend](#input\_create\_aws\_secret\_backend) | Enable AWS Secret Method or not for Vault | `bool` | n/a | yes |
| <a name="input_create_aws_secret_backend_user"></a> [create\_aws\_secret\_backend\_user](#input\_create\_aws\_secret\_backend\_user) | Enable AWS Secret Method or not for Vault | `bool` | n/a | yes |
...
| <a name="input_create_secret_backend_role"></a> [create\_secret\_backend\_role](#input\_create\_secret\_backend\_role) | Enable a role on an AWS Secret Method or not for Vault | `bool` | n/a | yes |
| <a name="input_create_secret_backend_role_user"></a> [create\_secret\_backend\_role\_user](#input\_create\_secret\_backend\_role\_user) | Enable a role on an AWS Secret Method for Vault | `bool` | n/a | yes |
| <a name="input_create_secret_role"></a> [create\_secret\_role](#input\_create\_secret\_role) | Enable Secrets JWT Auth Method Role or not | `bool` | n/a | yes |
...
| <a name="input_enabled_jwt_backend"></a> [enabled\_jwt\_backend](#input\_enabled\_jwt\_backend) | Enable JWT Auth Method or not | `bool` | n/a | yes |
...
| <a name="input_secret_bound_claims"></a> [secret\_bound\_claims](#input\_secret\_bound\_claims) | JWT/OIDC auth Method role for Secrets values in a Vault server | <pre>map(object({<br>    role_name    = string<br>    bound_claims = map(string)<br>  }))</pre> | n/a | yes |
